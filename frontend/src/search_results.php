                    ...
                    <div class="row" style="justify-content: start;">
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($product = $result->fetch_assoc()) {
                                ...
                                echo "<a href='product_details.php?product_id=" . $product['product_id'] . "' style='text-decoration: none; color: inherit;'>";
                                ...
                                displayrating(number_format($product['product_rating'], 1));
                                echo "<p class='card-price'>$" . number_format($product['product_price'], 2) . "</p>";
                                echo "</div>";
